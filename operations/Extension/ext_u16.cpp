...
{
    // 14xx - U16 Moves & Casts
    Set16 = SPtr<Operation>(new Operation(
    ...
    CopyFrom16 = SPtr<Operation>(new Operation(
    ...
    CopyTo16 = SPtr<Operation>(new Operation(
    ...
    Copy16 = SPtr<Operation>(new Operation(
    ...
    Push16 = SPtr<Operation>(new Operation(
    ...
    Pop16 = SPtr<Operation>(new Operation(
    ...
    CastTo16 = SPtr<Operation>(new Operation(
    ...
    CastFrom16 = SPtr<Operation>(new Operation(
    ...
    Copy16If = SPtr<Operation>(new Operation(
    ...
    // 15xx - U16 Operations
    Add16 = SPtr<Operation>(new Operation(
    ...
    Substract16 = SPtr<Operation>(new Operation(
    ...
    Multiply16 = SPtr<Operation>(new Operation(
    ...
    Divide16 = SPtr<Operation>(new Operation(
    ...
    Modulo16 = SPtr<Operation>(new Operation(
    ...
    Random16 = SPtr<Operation>(new Operation(
    ...
    Compare16 = SPtr<Operation>(new Operation(
    ...
    // 17xx - U16 I/O
    Write16 = SPtr<Operation>(new Operation(
        ...
        { { SIZE8 } }));
    Read16 = SPtr<Operation>(new Operation(
    ...
    WriteUtf16 = SPtr<Operation>(new Operation(
