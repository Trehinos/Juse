...
S<Operation> ChangeFrequency = S<Operation>(new Operation(
...
S<Operation> ShortThread = S<Operation>(new Operation(
    ...
    { { SIZE16 }, { SIZE32 } }));
S<Operation> ThreadAt = S<Operation>(new Operation(
